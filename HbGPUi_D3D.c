...
DXGI_FORMAT HbGPUi_D3D_Image_Format_ToTyped(HbGPU_Image_Format format) {
	...
	static DXGI_FORMAT const dxgiFormats[] = {
		...
		[HbGPU_Image_Format_11_11_10_RGB_UFloat] = DXGI_FORMAT_R11G11B10_FLOAT,
		...
		[HbGPU_Image_Format_16_R_SFloat] = DXGI_FORMAT_R16_FLOAT,
		...
		[HbGPU_Image_Format_16_16_RG_SFloat] = DXGI_FORMAT_R16G16_FLOAT,
		...
		[HbGPU_Image_Format_32_32_RG_SFloat] = DXGI_FORMAT_R32G32_FLOAT,
		...
		[HbGPU_Image_Format_32_32_32_32_RGBA_SFloat] = DXGI_FORMAT_R32G32B32A32_FLOAT,
		...
		[HbGPU_Image_Format_BPTC_UFloat] = DXGI_FORMAT_BC6H_UF16,
		[HbGPU_Image_Format_BPTC_SFloat] = DXGI_FORMAT_BC6H_SF16,
		[HbGPU_Image_Format_BPTC_UNorm] = DXGI_FORMAT_BC7_UNORM,
		[HbGPU_Image_Format_BPTC_sRGB] = DXGI_FORMAT_BC7_UNORM_SRGB,
...
DXGI_FORMAT HbGPUi_D3D_Image_Format_ToTypeless(HbGPU_Image_Format format) {
	...
	static DXGI_FORMAT const dxgiFormats[] = {
		...
		[HbGPU_Image_Format_16_R_SFloat] = DXGI_FORMAT_R16_TYPELESS,
		...
		[HbGPU_Image_Format_16_16_RG_SFloat] = DXGI_FORMAT_R16G16_TYPELESS,
		...
		[HbGPU_Image_Format_32_32_RG_SFloat] = DXGI_FORMAT_R32G32_TYPELESS,
		...
		[HbGPU_Image_Format_32_32_32_32_RGBA_SFloat] = DXGI_FORMAT_R32G32B32A32_TYPELESS,
		...
		[HbGPU_Image_Format_BPTC_UFloat] = DXGI_FORMAT_BC6H_TYPELESS,
		[HbGPU_Image_Format_BPTC_SFloat] = DXGI_FORMAT_BC6H_TYPELESS,
		[HbGPU_Image_Format_BPTC_UNorm] = DXGI_FORMAT_BC7_TYPELESS,
		[HbGPU_Image_Format_BPTC_sRGB] = DXGI_FORMAT_BC7_TYPELESS,
